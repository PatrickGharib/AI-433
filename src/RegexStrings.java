...
//    String COMMA = ("[\\s]*,[\\s]*");
    ...
    public static final String NOTCOMPATABLE = COURSES + "|" + LABS + "," + COURSES + "|" + LABS;
    ...
    public static final String PREFERENCES_L = COURSE_VALID_DAY + "," + TIMES + "," + COURSES + "[\\s]*([\\d]+)[\\s]*";
    public static final String PAIR = NOTCOMPATABLE;
    public static final String PARTIALASSIGNMENT = UNWANTED_C;

//    public static void main(String args[]){
//        String line = ("CPSC 433 LEC 01 TUT 01, CPSC 433 LEC 02 LAB 02");
////        if (line.matches(NOTCOMPATABLE)){
//            System.out.println(NOTCOMPATABLE);
////        }
